...
def test_v2_exports_the_whole_public_surface():
    expected = {
        ...
        # Custom signal and rule authoring: what a signal's silence means, and
        # the policy vocabulary a rule is written in.
        "SIGNAL_KIND_EVENT",
        ...
        "NEED_MAJORITY",
        "RULE_STATE_DOWN",
        # Where alerts go (1.8.0): the two transports, the three alert kinds, the
        # two meanings of an empty delivery table, and whether an attempt landed.
        "ALERT_KINDS",
        "ALERT_KIND_NO_DATA",
        "ALERT_KIND_PROBLEM",
        "ALERT_KIND_RECOVERY",
        ...
        # 1.8.0 payloads: a destination, a template, a preview of one, a
        # subject's table, and a recorded attempt.
        "DeliveryRecord",
        "DeliverySelection",
        "Destination",
        "Incident",
        ...
        "from_api_workspace",
        # The two policy translators: `from` is a Python keyword, so a rule
        # input is `from_rule` on this side and `from` on the wire.
